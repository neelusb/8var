    ...
    while len(inp) > 0 and errmsg == '':
        ...
        #                     toStr = ''
            ...
            if inp.lower()[0]=="'":
                ...
                if inp.lower()[0] in "01234567l":
                    if inp.lower()[0]=="l":
                        evarout = evarout + (str(varInt[int(lastInt)]))
                    else:
                        evarout = evarout + (str(varInt[int(inp[0])]))
                    inp=inp[1:]
                else:
                    errmsg = ("\n[8var] ERROR: Variable doesn't exist.")
            elif inp.lower().startswith("float"):
                ...
                if inp.lower()[0] in "01234567l":
                    if inp.lower()[0]=="l":
                        evarout = evarout + (str(varFloat[int(lastFloat)]))
                    else:
                        evarout = evarout + (str(varFloat[int(inp[0])]))
                    inp=inp[1:]
                else:
                    errmsg = ("\n[8var] ERROR: Variable doesn't exist.")
            elif inp.lower().startswith("flt"):
                ...
                if inp.lower()[0] in "01234567l":
                    if inp.lower()[0]=="l":
                        evarout = evarout + (str(varStr[int(lastStr)]))
                    else:
                        evarout = evarout + (str(varStr[int(inp[0])]))
                    inp=inp[1:]
                else:
                    errmsg = ("\n[8var] ERROR: Variable doesn't exist.")
                ...
                if inp.lower()[0] in "01234567l":
                    if inp.lower()[0]=="l":
                        evarout = evarout + (str(varBool[int(lastBool)]))
                    else:
                        evarout = evarout + (str(varBool[int(inp[0])]))
                    inp=inp[1:]
                else:
                    errmsg = ("\n[8var] ERROR: Variable doesn't exist.")
